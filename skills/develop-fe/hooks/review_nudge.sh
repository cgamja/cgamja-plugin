...
context "[develop-fe] 코드 리뷰는 Agent 도구로 즉석 제작하지 않는다 — Skill 도구로 cgamja:review-cgamja(철학·SPEC 대조) 와 Agent 도구의 cgamja-private:code-review-opus(버그 리뷰, Opus 고정) 2축을 부른다(workflow 2장 5번, adr/0026). 이 Agent 호출이 리뷰 목적이면 취소하고 그 둘로 대체하라."
