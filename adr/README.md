...
| [0034](0034-review-split-code-seo-combined.md) | 리뷰를 셋으로 — `review-code`(철학+정확성) · `review-seo`(claude-seo 렌즈를 상황별로 골라 병렬, 빌드 결과 로컬 서빙, inspect_html 전후 비교) · `review-cgamja`(둘을 한 메시지에 스폰해 겹치는 파일을 한 번에 수정) | 제안 | — |
