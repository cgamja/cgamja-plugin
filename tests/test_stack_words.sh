...
for f in skills/develop-setup/SKILL.md skills/develop-fe/SKILL.md skills/develop-fe/workflow.md skills/develop-baby-fe/SKILL.md skills/test-fe/SKILL.md skills/review-fe/SKILL.md agents/reviewer-*.md; do
