...
description: 렌즈 L5 플랫폼 적합성. .claude/rules/platform.md 프로필(웹/모바일 웹/Expo)에 맞춰 뷰포트 증거 전부·안전영역·키보드·터치 타깃·다크모드·hover-only·px/100vh를 본다. review-fe 스킬이 UI task가 있을 때 호출한다.
model: sonnet
